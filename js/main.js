    ...
    contactForm.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          formStatus.textContent = 'No se pudo enviar. Intenta de nuevo o escríbeme directo por correo.';
        }
      } catch (error) {
        formStatus.textContent = 'No se pudo enviar. Revisa tu conexión e intenta de nuevo.';
      } finally {
